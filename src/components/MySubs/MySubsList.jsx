...
export default function MySubsList() {
    ...
    React.useEffect(() => {
        const getData = async () => {
            try {
                const url = "https://dairy-management-backend-5m7b.onrender.com/api/customer/getSubs"
    ...
    const handleDelete = async (id) => {
        try {
            const url = "https://dairy-management-backend-5m7b.onrender.com/api/customer/removeSub"
