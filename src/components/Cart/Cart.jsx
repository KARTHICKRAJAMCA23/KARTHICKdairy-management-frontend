...
export default function FilesExample() {
  ...
  async function handleCheck(product) {
    ...
    try {
      const url = "https://dairy-management-backend-5m7b.onrender.com/api/customer/updateCart"
  ...
  async function handleAddSubscription(){
    try {
      const url = "https://dairy-management-backend-5m7b.onrender.com/api/customer/addSub"
  ...
  React.useEffect(() => {
    const getData = async () => {
      try {
        const url = "https://dairy-management-backend-5m7b.onrender.com/api/customer/getCart"
