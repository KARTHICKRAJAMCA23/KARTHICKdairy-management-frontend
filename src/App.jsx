    ...
    useEffect(() => {
        async function fetchData() {
            if (setToken())
                navigate('/')
            try {
                const response = await axios.get('https://dairy-management-backend-5m7b.onrender.com/api/vendor');
    ...
    useEffect(() => {
        async function fetchData() {
            if (setToken())
                navigate('/')
            try {
                const response = await axios.get('https://dairy-management-backend-5m7b.onrender.com/api/customer');
